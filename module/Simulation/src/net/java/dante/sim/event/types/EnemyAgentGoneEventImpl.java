 ...
 * @author M.Olszewski
 */
class EnemyAgentGoneEventImpl extends AbstractEnemyAgentEvent implements EnemyAgentGoneEvent
{
  ...
  /**
   * Creates instance of {@link EnemyAgentGoneEventImpl} class.
   *
   ...
   */
  public EnemyAgentGoneEventImpl(int eventId, long eventTime, int enemyAgentId,
                                 double enemyDestinationX, double enemyDestinationY,
                                 double enemySpeedX, double enemySpeedY)
  {
    super(eventId, eventTime, EventType.ENEMY_AGENT_GONE, enemyAgentId);
  ...
  public boolean equals(Object object)
  {
    ...
    if (equal && (object instanceof EnemyAgentGoneEvent))
    {
      final EnemyAgentGoneEvent other = (EnemyAgentGoneEvent) object;
