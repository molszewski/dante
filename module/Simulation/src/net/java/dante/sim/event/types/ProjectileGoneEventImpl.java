...
/**
 * Implementation of {@link ProjectileGoneEvent} interface.
 *
 * @author M.Olszewski
 */
class ProjectileGoneEventImpl extends AbstractProjectileEvent implements ProjectileGoneEvent
{
  ...
  /**
   * Creates instance of {@link ProjectileGoneEventImpl} class.
   *
   ...
   */
  ProjectileGoneEventImpl(int eventId, long eventTime,
      int projectileId,
      double projectileDestinationX, double projectileDestinationY,
      double projectileSpeedX, double projectileSpeedY)
  {
    super(eventId, eventTime, EventType.PROJECTILE_GONE, projectileId);
  ...
  public boolean equals(Object object)
  {
    ...
    if (equal && (object instanceof ProjectileGoneEvent))
    {
      final ProjectileGoneEvent other = (ProjectileGoneEvent) object;
