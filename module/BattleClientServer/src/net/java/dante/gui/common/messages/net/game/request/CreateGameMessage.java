...
/**
 * Class representing message with request to create new game.
 * 
 * @author M.Olszewski
 */
public class CreateGameMessage extends GameRequestMessage
{
  /**
   * Creates instance of {@link CreateGameMessage} class.
   */
